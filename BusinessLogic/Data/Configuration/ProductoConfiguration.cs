...
namespace BusinessLogic.Data.Configuration
{
    public class ProductoConfiguration : IEntityTypeConfiguration<Producto>
    {
        public void Configure(EntityTypeBuilder<Producto> builder)
        {
            ...
            builder.HasOne(m => m.Marca).WithMany().HasForeignKey(p => p.MarcaId); // Relación con Marca
            builder.HasOne(c => c.Categoria).WithMany().HasForeignKey(p => p.CategoriaId); // Relación con Categoria
        }
    }
}
